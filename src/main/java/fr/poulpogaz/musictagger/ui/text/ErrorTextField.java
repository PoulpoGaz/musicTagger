...
import fr.poulpogaz.musictagger.ui.layout.VerticalConstraint;
import fr.poulpogaz.musictagger.ui.layout.VerticalLayout;
...
public class ErrorTextField extends JPanel {
    ...
    private final MTextField field;
    ...
    public ErrorTextField(Document doc, String text, int columns) {
        field = new MTextField(doc, text, columns);
