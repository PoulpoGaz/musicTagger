...
import fr.poulpogaz.musictagger.ui.dialogs.MetadataDialog;
import fr.poulpogaz.musictagger.ui.dialogs.SingleMetadataEditorDialog;
...
public class TemplateTable extends JPanel {
        ...
        Action action = new AbstractMAction("Show all metadata", table) {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (row >= 0) {
                    ...
                    if (!m.isDownloading()) {
                        MetadataDialog.showDialog(MTFrame.getInstance(), m);
                    }
                }
            }
        ...
        return new PopupMenuListener() {
            ...
            public void popupMenuWillBecomeVisible(PopupMenuEvent e) {
                if (Templates.templateCount() <= 1
                    ...
                    TemplatesPanel panel = MTFrame.getInstance().getTemplatesPanel();
    ...
    private void openSingleMetadataEditor(int row, int column) {
        if (tableModel.canOpenTagEditor(row, column)) {
            ...
            SingleMetadataEditorDialog.showDialog(MTFrame.getInstance(), m, key);
        }
    }
