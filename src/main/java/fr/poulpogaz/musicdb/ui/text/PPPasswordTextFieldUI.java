...
public class PPPasswordTextFieldUI extends FlatPasswordFieldUI {
    ...
    public static ComponentUI createUI(JComponent c) {
        return new PPPasswordTextFieldUI();
    }
    ...
    public void installUI(JComponent c) {
        ...
        if (c instanceof PPPasswordTextField field) {
            if (trailingComponent != null) {
                field.add(trailingComponent, PPTextFieldLayout.TRAIL);
            }

            if (leadingComponent != null) {
                field.add(leadingComponent, PPTextFieldLayout.LEAD);
            }
        }
    }
    ...
    protected void installListeners() {
        ...
        if (component instanceof PPPasswordTextField field) {
    ...
    protected Dimension getSize(JComponent c, boolean prefOrMin) {
        ...
        if (c instanceof PPPasswordTextField) {
    ...
    public void setTrailingComponent(Component trailingComponent) {
        if (this.trailingComponent != trailingComponent && getComponent() instanceof PPPasswordTextField) {
    ...
    public void setLeadingComponent(Component leadingComponent) {
        if (this.leadingComponent != leadingComponent && getComponent() instanceof PPPasswordTextField) {
