...
public class PPTextFieldUI extends FlatTextFieldUI {
    ...
    public void installUI(JComponent c) {
        ...
        if (c instanceof PPTextField field) {
    ...
    protected void installListeners() {
        ...
        if (component instanceof PPTextField field) {
    ...
    public void setTrailingComponent(Component trailingComponent) {
        if (this.trailingComponent != trailingComponent && getComponent() instanceof PPTextField) {
    ...
    public void setLeadingComponent(Component leadingComponent) {
        if (this.leadingComponent != leadingComponent && getComponent() instanceof PPTextField) {
